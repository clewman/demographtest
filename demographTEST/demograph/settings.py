"""
Django settings for demograph project.
...
SECRET_KEY = '*m##y0*mf_w-e(cy*a4dc8s6zcs!z0qe526b$nzr!g%jb!f84n'
...
WSGI_APPLICATION = 'demograph.wsgi.application'
